        ...
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('success', 'Yor are logged in successfully');
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('success', 'Yor are sign in successfully');
              window.setTimeout(function () {
                location.assign('/');
              }, 100);
            }
...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoidGhla2F1c2hhbHNhcmFzd2F0IiwiYSI6ImNrN29lenBhYzA4NGUza24xejZ0NTMwc2cifQ.Cy6CQrWu8MdwOHWrZJNH2A';
...
var stripe = Stripe('pk_test_u3TVIhpor5vEagx66CLHgnt8000Gipx9Fy');
...
if (signinForm) signinForm.addEventListener('submit', function (e) {
  ...
  (0, _signin.signin)(name, email, password, passwordConfirm);
});
